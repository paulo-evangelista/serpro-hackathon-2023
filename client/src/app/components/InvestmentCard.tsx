...
const InvestmentCard = ({ title, yieldAnnual, minimumInvestment, dueDate }: { title: string, yieldAnnual: string, minimumInvestment: string, dueDate: string }) => {
	return (
		<div className="max-w-sm rounded overflow-hidden shadow-lg bg-white p-6 m-4">
			<div className="font-bold text-xl mb-2">{title}</div>
			<p className="text-gray-700 text-base mb-4">Rentabilidade anual: {yieldAnnual}</p>
			<p className="text-gray-700 text-base mb-4">Investimento mínimo: R$ {minimumInvestment}</p>
			<p className="text-gray-700 text-base mb-6">Vencimento: {dueDate}</p>
	...
	return (
	  <div className="bg-purple-700 p-10">
		<div className="container mx-auto">
		  <h2 className="text-white text-3xl font-bold mb-6">OPÇÕES DE TÍTULOS</h2>
