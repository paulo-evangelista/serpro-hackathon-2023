            ...
            <div className="flex flex-row h-screen">
                <div className="w-1/3 bg-[#002c63] bg-cover bg-left flex flex-col justify-center items-center">
                    <div className="flex flex-col justify-center items-center w-full">
                        <h1 className="text-2xl text-white font-bold mb-8">Cadastro de corretora</h1>
                ...
                <div className="w-2/3 bg-cover bg-left flex items-center justify-center" style={{ backgroundImage: "url(https://napratica.org.br/wp-content/uploads/2018/09/btg-pactual.jpg)" }}></div>
            </div>
        </div>
	);
}